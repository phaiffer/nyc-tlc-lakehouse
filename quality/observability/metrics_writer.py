...
def write_pipeline_metrics(
    ...
    # coalesce(1): spark.createDataFrame() on local data defaults to sc.defaultParallelism
    # partitions, which would spawn one Python worker per core for a single-row DataFrame.
    metrics_df = (
